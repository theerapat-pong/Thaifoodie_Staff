// ========================================
// LIFF Admin Approve Endpoint
// POST /api/liff/admin/approve
// ========================================
...
module.exports = async function handler(req, res) {
    ...
    try {
        ...
        try {
            ...
            console.error('[Admin Approve] Failed to notify user:', notifyError);
        }
        ...
        await logger.error(
            'Admin',
            'Approve-Request',
            `Error approving ${req.body?.type} request: ${error.message}`,
            {
                error: error.message,
                stack: error.stack,
